...
class DatabaseConn {	
  ...
  public function dbOpen(){
    ...
    try {
      ...
      $dbHost = 'localhost';
      $dbName = 'wipeck';//this will be your WCC username
      $dbUsr = 'wipeck';//this will be your WCC username
      $dbPass = 'jeJQn3y8yjUtXMl';//this will be the password found in the video.
